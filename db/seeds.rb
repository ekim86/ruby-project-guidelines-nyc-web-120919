...
uncut_gems = Movie.create(title: "Uncut Gems", synopsis: "A charismatic jeweler makes a high-stakes bet that could lead to the windfall of a lifetime. In a precarious high-wire act, he must balance business, family and adversaries on all sides in pursuit of the ultimate win.", showtimes: "7:00PM, 8:00PM, 9:00PM, 10:00PM", content_rating: "R")
star_wars = Movie.create(title: "Star Wars: The Rise of Skywalker", synopsis: "The surviving Resistance faces the First Order once more as Rey, Finn and Poe Dameron's journey continues. With the power and knowledge of generations behind them, the final battle commences.", showtimes: "5:30PM, 7:30PM, 9:30PM, 11:30PM", content_rating: "PG-13")
jumanji = Movie.create(title: "Jumanji: The Next Level", synopsis: "When Spencer goes back into the fantastical world of Jumanji, pals Martha, Fridge and Bethany re-enter the game to bring him home. But the game is now broken -- and fighting back. Everything the friends know about Jumanji is about to change, as they soon discover there's more obstacles and more danger to overcome.", showtimes: "12:00PM, 2:00PM, 4:00PM, 6:00PM", content_rating: "PG-13")
cats = Movie.create(title: "Cats", synopsis: "A tribe of cats must decide yearly which one will ascend to the Heaviside Layer and come back to a new life.", showtimes: "4:00PM, 5:00PM, 6:00PM, 7:00PM", content_rating: "PG")
frozen_2 = Movie.create(title: "Frozen 2", synopsis: "Elsa the Snow Queen has an extraordinary gift -- the power to create ice and snow. But no matter how happy she is to be surrounded by the people of Arendelle, Elsa finds herself strangely unsettled. After hearing a mysterious voice call out to her, Elsa travels to the enchanted forests and dark seas beyond her kingdom -- an adventure that soon turns into a journey of self-discovery.", showtimes: "3:00PM, 4:00PM, 5:OOPM, 6:00PM", content_rating: "PG")
